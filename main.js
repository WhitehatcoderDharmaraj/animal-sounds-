...
classifier=ml5.soundClassifier('https://teachablemachine.withgoogle.com/models/1S49wamzr/model.json',modelReady);
}
...
img_1=document.getElementById("img");

if(results[0].label == "Braking"){
    img_1.src='Brak.gif';
}
